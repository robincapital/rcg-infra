...
##  Adds: USE_NEW_PRICE_TARGETS, PT_APPLY_ENVELOPE, PT_R2_FLOOR/FULL,
##        BLOOMBERG_INTRADAY_MAX
## ════════════════════════════════════════════════════════════════════
import sys, re

# Clear cached imports (incl. price_targets so config edits take effect)
...
OVERRIDE_FACTOR          = 0.4         # 0.0 = no effect | 1.0 = full force
...
# Cap on number of tickers the intraday puller monitors. Currently puller
# runs on watchlist (6); raise this once the dynamic-watchlist builder ships.
BLOOMBERG_INTRADAY_MAX   = 50          # adjust based on BBG license throughput
# ══════════════════════════════════════════════════════
